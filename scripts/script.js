...
const resultsContainer = document.getElementById('results'); //1
const modalTitle = document.getElementById('modalTitle'); //2
const modalImage = document.getElementById('modalImage'); //3
const modalIngredients = document.getElementById('modalIngredients'); //4
const modalInstructions = document.getElementById('modalInstructions'); //5
